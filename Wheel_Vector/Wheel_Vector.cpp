#include "Wheel_Vector.hpp"

Wheel_Vector::Wheel(float radius, float wheel_rad, float beta_rad, float gamma_rad) {
 ...
 * @param gamma_rad
 */
void Wheel_Vector::set_parameters(float radius, float wheel_rad, float beta_rad, float gamma_rad) {
  _radius = radius;
 ...
 */
float Wheel_Vector::get_velocity(float x, float y, float theta) {
